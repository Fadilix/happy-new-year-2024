...
const WishForm: React.FC = () => {
    ...
    const lk = `https://happy-new-year-2024-two.vercel.app/wish/?sender=${formData.sender.trim().replace(" ", "_")}&receiver=${formData.receiver.trim().replace(" ", "_")}&lang=${formData.language}`
            ...
            <div className='form-container'>
                ...
                {formData.receiver && formData.sender && (
                    <div className="results">
                        <Link to={`/wish/?sender=${formData.sender.trim().replace(" ", "_")}&receiver=${formData.receiver.trim().replace(" ", "_")}&lang=${formData.language}`}>{link}</Link>
